...
public class CurrentStudent extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] courses = getResources().getStringArray(R.array.computerEngineeringCourses);
        String[] courses1 = getResources().getStringArray(R.array.softwareEngineeringCourses);
        ...
        checkBox1.setTypeface(CourseGuide.robotoMedium);
        checkBox2.setTypeface(CourseGuide.robotoMedium);
        checkBox3.setTypeface(CourseGuide.robotoMedium);
        checkBox4.setTypeface(CourseGuide.robotoMedium);
        ...
        txtview.setTypeface(CourseGuide.robotoRegular);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(CurrentStudent.this, GettingIntoItu.class);
            startActivity(intent);
        }
