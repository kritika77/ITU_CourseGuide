...
public class planNetworking extends AppCompatActivity {
    ...
    public ArrayList<groupFaq> SetStandardGroups() {
        ...
        ch2_1.setName("Except SWE 500 and Electives, the instructor, not graduate advisor, makes decisions. If you believe you have sufficient background to take the class, you can enroll in the class and then request the instructor's consent. If the instructor denies your request, you must drop the class during the first two weeks of the semester. Graduate advisor enforces the prerequisites of CMPE 200 and 220 without exceptions.");
        ...
        ch3_1.setName("A thesis has a more rigid requirements of contents and reporting style. A project-track student must enroll in CMPE 295A and CMPE 295B in two consecutive semesters A thesis-track student must enroll in SWE 500 and SWE 600 in two consecuive semesters. Summer enrollments are optional.");
        ...
        ch6_1.setName("Courses may be added or dropped without penalty during the first fourteen days of classes. See the Calendar section of www.itu.edu/registrar for exact dates and deadlines.Courses dropped during this initial period will not appear on the student's transcript.");
        ...
        gru9.setName("Can I transfer graduate credits from other graduate schools or Universities?");

        childFaq ch9_1 = new childFaq();
        ch9_1.setName("You can transfer up to 9 semester units. Transfer credit work can be courses taken at another university (in graduate standing only), ITU courses, or courses that were taken during the last semester as an ITU senior. A course can't be transferred if is counted as part of the study program of another degree.\n" +
                "Transfer work must be from institutions that were listed on your initial application to ITU and must be from an accredited institution. Other restrictions are indicated in the university catalog.\n" +
                ...
                "After the first week of each semester, a student can submit a package for each transferring course to the department office per the instructions listed on “Transfer non-ITU or Open University course request form” (http://itu.edu/content/request-forms)");
