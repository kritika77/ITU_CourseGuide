...
public class Plan2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExpAdapter = new ExpandListAdapterFaq(Plan2.this, ExpListItems);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(Plan2.this,PlanYourSchedule.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.discussion_forum)
        {
            //Intent intent = new Intent(Plan2.this,DiscussionForum.class);
            //startActivity(intent);
            //Intent intent = new Intent(Plan2.this, main_discussion_forum_list.class);
            //startActivity(intent);

        } else if (id == R.id.nav_slideshow)    //FAQs
        {
            Intent intent = new Intent(Plan2.this, faq.class);
            startActivity(intent);
        } else if (id == R.id.nav_manage)   //Gettting into ITU
        {
            Intent intent = new Intent(Plan2.this, GettingIntoItu.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(Plan2.this, Accomodation.class);
            startActivity(intent);
