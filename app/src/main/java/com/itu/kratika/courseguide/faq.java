...
public class faq extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExpAdapter = new ExpandListAdapterFaq(faq.this, ExpListItems);
    ...
    public ArrayList<groupFaq> SetStandardGroups() {
        ...
        ch5_1.setName("You can only enroll into one of them. The Graduate Advisor is not assigned to schedule the classes of the department. The department will post additional sections, if any, on the the schedule section of myITU. If the overlap time is less than 15 minutes, you might be able to enroll into both classes by filing a course overlap form to the department office.");
        ...
        gru9.setName("Can I transfer graduate credits from other graduate schools Universities?");

        childFaq ch9_1 = new childFaq();
        ch9_1.setName("You can transfer up to 9 semester units. Transfer credit work can be courses taken at another university (in graduate standing only), ITU Open University courses, or courses that were taken during the last semester as an ITU senior. A course can't be transferred if is counted as part of the study program of another degree.\n" +
                ...
                "After the first week of each semester, a student can submit a package for each transferring course to the department office per the instructions listed on “Transfer non-ITU or Open University course request form” (http://cmpe.itu.edu/content/request-forms)");
