...
public class Plan02 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plan02);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        ExpandList = (ExpandableListView) findViewById(R.id.exp_list);
        ExpListItems = SetStandardGroups();
        ExpAdapter = new ExpandListAdapterFaq(Plan02.this, ExpListItems);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(Plan02.this,PlanYourSchedule.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.discussion_forum)
        {
            //Intent intent = new Intent(Plan02.this,DiscussionForum.class);
            //startActivity(intent);
            //Intent intent = new Intent(Plan02.this, main_discussion_forum_list.class);
            //startActivity(intent);

        } else if (id == R.id.nav_slideshow)    //FAQs
        {
            Intent intent = new Intent(Plan02.this, faq.class);
            startActivity(intent);
        } else if (id == R.id.nav_manage)   //Gettting into ITU
        {
            Intent intent = new Intent(Plan02.this, GettingIntoItu.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(Plan02.this, Accomodation.class);
            startActivity(intent);
    ...
    public ArrayList<groupFaq> SetStandardGroups() {
        ...
        ch3_1.setName("1st Sem:\n" +
                ...
                "\n2. If you have basic knowledge of networking its better to skip 242 and take Specialization from CMPE 243. 208 and 209.\n" +
        ...
        ch4_1.setName(
                "1st Sem:\n" +
                        ...
                        "5th Sem:\n" +
                        "CMPE 295B"+
                        "\nNote:\n 1. If you have basic knowledge of networking its better to skip 242 and take Specialization from 243.208 and 209.\n" +
