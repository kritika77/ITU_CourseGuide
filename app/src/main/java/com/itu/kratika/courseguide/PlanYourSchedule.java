...
public class PlanYourSchedule extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtView.setText(Html.fromHtml("<br><h1><strong><font color=#0000FF>Program Scope</font></strong></h1><em>The MS SWE program currently has three areas of specialization:</em><br>" +
                "<br><ul><font color=#000000> " +
                "<li><font color=#000000>Computer Engineering</font></li><br>" +
                "<li><font color=#000000>Software Engineering</font></li><br>" +
                "<li><font color=#000000>Engineering Management</font></li>" +
                "</font></ul>" +
        ...
        textView3.setTypeface(CourseGuide.robotoMedium);

        TextView textView4 = (TextView) findViewById(R.id.current);
        textView4.setTypeface(CourseGuide.robotoMedium);

        TextView textView5 = (TextView) findViewById(R.id.departmentInfo);
        textView5.setTypeface(CourseGuide.robotoRegular);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(PlanYourSchedule.this, GettingIntoItu.class);
            startActivity(intent);
        }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.itu.kratika.courseguide/http/host/path")
        );
