...
public class PlanSem2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plan_sem2);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        ExpandList = (ExpandableListView) findViewById(R.id.exp_list);
        ExpListItems = SetStandardGroups();
        ExpAdapter = new ExpandListAdapterFaq(PlanSem2.this, ExpListItems);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.plan_sem2, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(PlanSem2.this,PlanYourSchedule.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.discussion_forum)
        {
            // Intent intent = new Intent(PlanSem2.this,DiscussionForum.class);
            // startActivity(intent);
            // Intent intent = new Intent(PlanSem2.this, main_discussion_forum_list.class);
            // startActivity(intent);

        } else if (id == R.id.nav_slideshow)    //FAQs
        {
            Intent intent = new Intent(PlanSem2.this, faq.class);
            startActivity(intent);
        } else if (id == R.id.nav_manage)   //Gettting into ITU
        {
            Intent intent = new Intent(PlanSem2.this, GettingIntoItu.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(PlanSem2.this, Accomodation.class);
            startActivity(intent);
