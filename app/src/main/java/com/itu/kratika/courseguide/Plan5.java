...
public class Plan5 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExpAdapter = new ExpandListAdapterFaq(Plan5.this, ExpListItems);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.plan5, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(Plan5.this,PlanYourSchedule.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.discussion_forum)
        {
            //Intent intent = new Intent(Plan5.this,DiscussionForum.class);
            //startActivity(intent);
            //Intent intent = new Intent(Plan5.this, main_discussion_forum_list.class);
            //startActivity(intent);

        } else if (id == R.id.nav_slideshow)    //FAQs
        {
            Intent intent = new Intent(Plan5.this, faq.class);
            startActivity(intent);
        } else if (id == R.id.nav_manage)   //Gettting into ITU
        {
            Intent intent = new Intent(Plan5.this, GettingIntoItu.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(Plan5.this, Accomodation.class);
            startActivity(intent);
...
//DD and oops
        ...
        ch3_1.setName("1st Sem:\n" +
                ...
                "CMPE 295B\n"+
                "Note:\n"+
                "1.This plan allows you to finish off both pre requisites in first semester.\n" +
