...
public class MainActivity extends AppCompatActivity
    ...
    public static final String[] IMAGE_NAME = {"itulogo", "itu6", "itu2", "itu3", "itu4", "itu5", "itu7"};
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(MainActivity.this, GettingIntoItu.class);
            startActivity(intent);
        }
    ...
    public static class SwipeFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            int imgResId = getResources().getIdentifier(imageFileName, "drawable", "com.itu.kratika.courseguide");
