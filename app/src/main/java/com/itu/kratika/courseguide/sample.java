...
public class sample extends MainActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(sample.this,PlanYourSchedule.class);
        ...
        {
            Intent intent = new Intent(sample.this, faq.class);
            startActivity(intent);
        } else if (id == R.id.nav_manage)   //Gettting into ITU
        {
            Intent intent = new Intent(sample.this, GettingIntoItu.class);
            startActivity(intent);
